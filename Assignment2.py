...
route = (geneticAlgorithm(population= cities, popSize=20, eliteSize=20, mutationRate=0.01, generations=100))
...
route2 = (geneticAlgorithm(population= cities1, popSize=8, eliteSize=8, mutationRate=0.01, generations= 50))
